...
<body>
    ...
    $sql="SELECT * from signup where rollno='$rollno'";
    $result_1=mysqli_query($conn,$sql);
    $result1=mysqli_fetch_array($result_1);
    $sql="SELECT * from user_details where rollno='$rollno'";
...
<!-- header-end -->
    ...
    <div class="ilstration_img wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".2s">
          <img src="<?php echo $result1['profile_pic_path'];?>" width="400" id="profile_pic">
          ...
          <div class="d-none d-lg-block" id="cen">
            <a class="boxed-btn3" href="../home/profile_update.html">Update</a>
        </div>
    </div>
           ...
           <div class="container">
               ...
               <div class="row">
                   ...
                   <div class="col-md-6 col-lg-3">
                       <div class="single_candidates text-center">
                           <div class="thumb">
                               <img src="http://localhost/alt/profile/img/logo/location-pin.jpg" alt="">
                           </div>
                   ...
                   <div class="col-md-6 col-lg-3">
                    <div class="single_candidates text-center">
                        <div class="thumb">
                            <img src="img/logo/email-loo.png" alt="">
                        </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="single_candidates text-center">
                    <div class="thumb">
                        <img src="img/logo/linkedin-logo.png" alt="150">
                    </div>
